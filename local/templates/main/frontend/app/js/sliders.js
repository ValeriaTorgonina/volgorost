...
export default class Sliders {
    constructor() {
        ...
        this.sliderIntro = [
            {
                'selector': '#sliderIntro .swiper-container',
                'options': {
                    slidesPerView: 1,
                    speed: 700,
                    loop: true,
                    ...
                    pagination: {
                        el: '#sliderIntro .swiper-pagination',
                        clickable: true,
                    },

                    navigation: {
                        nextEl: '#sliderIntro .swiper-button-next',
                        prevEl: '#sliderIntro .swiper-button-prev',
                    },
                }
            }
        ];
    ...
    init() {
        this.sliderIntro.forEach(function (slider) {
            if ($(slider.selector).find($('.swiper-slide')).length > 0) {
